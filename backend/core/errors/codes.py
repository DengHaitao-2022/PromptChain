...
LEGACY_NUMERIC_ERROR_CODES: dict[str, int] = {
    ...
    AUTH_REGISTRATION_CONFLICT: 40000,
    AUTH_LOGIN_LOCKED: 40000,
    COMMON_FORBIDDEN: 40300,
    AUTH_EMAIL_NOT_VERIFIED: 40300,
    AUTH_ACCOUNT_SUSPENDED: 40300,
    WORKSPACE_CONTEXT_REQUIRED: 40000,
    ...
    WORKSPACE_MEMBER_CONFLICT: 40000,
    WORKSPACE_INVITE_INVALID: 40000,
    WORKSPACE_MEMBER_STATE_INVALID: 40000,
