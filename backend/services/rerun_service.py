...
from models import WorkflowRun, WorkflowRunStatus, ArtifactType
            ...
            for aid in node["output_artifact_ids"]:
                ...
                if artifact_data:
                    ...
                    if artifact_type == ArtifactType.INTENT_CARD.value:
                        ...
                        if section_id:
                            preserved_state["draft_sections"][section_id] = content.get("content", "")
...
# 全局实例
_rerun_service: Optional[RerunService] = None
